...
def findLargestSubtreeSumUtil(root : Optional['Node'], ans) -> int:
    if (root == None):
        return 0
    
    currSum = (root.data + findLargestSubtreeSumUtil(root.left, ans) + findLargestSubtreeSumUtil(root.right, ans))
